      ...
      <div className={classes.feedback_container}>
        ...
        <div className={classes.wrapper}>
          ...
          <div className="feedback-instructions">
            <p>
              We collect feedback yearly. This is an essential tool for
              developing as professionals for all of us so please fill this form
              carefully. Especially open comments are much appreciated!
            </p>
            ...
            <Formik initialValues={initialValues} onSubmit={handleSubmit}>
              {({ values }) => (
                <Form>
                  ...
                  <div className="radio-div">
                    <p>
                      Q1.4: The person is aligned with company best practices
                    </p>
                    <label>
                      <span>1</span>
                  ...
                  <div className="radio-div">
                    <p>
                      Q2.4: The person has a good attitude towards all the
                  ...
                  <div className="radio-div">
                    <p>
                      Q3.4: The person has a proactive way to take things
                      forward
                    </p>
                    <label>
                      <span>1</span>
                  ...
                  <div className="radio-div">
                    <p>
                      Q3.6: The person can take good care of personal workload
                  ...
                  <div className="radio-div">
                    <p>
                      Q5.2: The person is interested in developing themselves
                      and their skills
                    </p>
                    <label>
                      <span>1</span>
                  ...
                  <div className="radio-div">
                    <p>
                      Q5.3: The person sees change as an opportunity instead of
                      a threat
                    </p>
                    <label>
                      <span>1</span>
                  ...
                  <div className="radio-div">
                    <p>
                      Q6.2: The person can provide multiple options with pros
                      and cons on how to solve a problem
                    </p>
                    <label>
                      <span>1</span>
