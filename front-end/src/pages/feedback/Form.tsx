...
import SidebarUser from '../userdash/SidebarUser';
...
const FeedbackForm: React.FC = () => {
    ...
    const handleSubmit = (values: any) => {
      ...
      return (
        ...
        <h3 className="title-h2">Assessment</h3> 
            <div className="feedback-instructions">
                <p>We collect feedback yearly. This is an essential tool for developing as professionals for all of us so please fill this form carefully. Especially open comments are much appreciated!</p>
    
                <p className="underline">Few reminders! </p>
                    <p>- You are also evaluating your competence manager with the same form. Please consider them first and foremost as a manager, not through their specialist role.</p>
                    <p>- Project Managers are evaluating all the employees working in client projects, and are doing the evaluation from the client perspective. PM can also be asked to give feedback as a colleague.</p>
                ...
                <p>4 - Performance exceeds expectations, in your view the person in doing more than you think is expected on the job type or lever the person is currently working on.</p>
                <p>5 - Performance exceeds expectations fully in this area, person is performing on the next level and should be promoted to a higher level to a more demanding role. </p>
        ...
        <Formik initialValues={initialValues} onSubmit={handleSubmit}>
          {({ values }) => (
            ...
            <div className="selection-div">
              ...
              <label htmlFor="colleague">Who do you want to give feedback to?</label>
               <Field
                 component="select"
                 id="colleague"
                 name="colleague"
                ...
                //  multiple={true}
               >
                <option value="choice" disabled={true}>Choose One</option>
    ...
    {/* ----------- QUALITY FOCUS ------------ */}
                ...
                <div className="radio-div">
                <p>Q1.2: The person aims to improve the quality of the end result beyond expressed requirements</p>
                <label>
                <span>1</span>
                ...
                <div className="radio-div">
                <p>Q1.3: The person is living by the company values (passion, expertise, openness and care)</p>
                <label>
                <span>1</span>
                ...
                <div className="radio-div">
                <p>Q1.5: The person delivers quality even with limited resources (time, resources, information, guidance)</p>
                <label>
                <span>1</span>
     ...
     {/* ----------- PEOPLE SKILLS ------------ */}
              ...
              <h2>People Skills</h2>
                ...
                <div className="radio-div">
                <p>Q2.2: The person takes other people's views into consideration</p>
                <label>
                <span>1</span>
                ...
                <div className="radio-div">
                <p>Q2.3: The person isn't afraid to ask for help from others</p>
                <label>
                <span>1</span>
                ...
                <div className="radio-div">
                <p>Q2.4: The person has a good attitude towards all the aspects of their work</p>
                <label>
                <span>1</span>
    ...
    {/* ----------- SELF GUIDANCE ------------ */}
            ...
            <h2>Self Guidance</h2>
                ...
                <div className="radio-div">
                <p>Q3.2: The person can see our work from the client's perspective (note: the client can be internal)</p>
                <label>
                <span>1</span>
                ...
                <div className="radio-div">
                <p>Q3.4: The person has a proactive way to take things forward</p>
                <label>
                <span>1</span>
                ...
                <div className="radio-div">
                <p>Q3.6: The person can take good care of personal workload by prioritizing and delegating</p>
                <label>
                <span>1</span>
    ...
    {/* ----------- READINESS FOR CHANGE ------------ */}
            ...
            <h2>Readiness for change</h2>
                ...
                <div className="radio-div">
                <p>Q5.2: The person is interested in developing themselves and their skills</p>
                <label>
                <span>1</span>
                ...
                <div className="radio-div">
                <p>Q5.3: The person sees change as an opportunity instead of a threat</p>
                <label>
                <span>1</span>
                ...
                <div className="radio-div">
                <p>Q5.4: The person is ready to adopt new different working methods</p>
                <label>
                <span>1</span>
                ...
                <div className="radio-div">
                <p>Q5.5:The person is able to handle change and uncertainty</p>
                <label>
                <span>1</span>
    ...
    {/* ----------- CREATIVITY ------------ */}  
            ...
            <h2>Creativity</h2>
                ...
                <div className="radio-div">
                <p>Q6.2: The person can provide multiple options with pros and cons on how to solve a problem</p>
                <label>
                <span>1</span>
                ...
                <div className="radio-div">
                <p>Q6.3: The person can foresee and prevent negative outcomes of solutions and decisions</p>
                <label>
                <span>1</span>
